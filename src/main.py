...
def create_parser():
    ...
    parser.add_argument( '--lamklMin', default=0.1, type=float, 
      help='minimum impact of prior kl term (for RELEVANT factors)' )
    parser.add_argument( '--lamklMax', default=10.0, type=float, 
      help='maximum impact of prior kl term (for NOISE factors)' )
...
#    parser.add_argument( '--lr_rvec', default=1e-4, type=float, 
#      help='learning rate of the relevance vector' )
#    parser.add_argument( '--beta1_rvec', default=0.5, type=float, 
#      help='beta1 parameter of the Adam optimizer for the relevance vector' )
#    parser.add_argument( '--beta2_rvec', default=0.9, type=float, 
#      help='beta2 parameter of the Adam optimizer for the relevance vector' )
